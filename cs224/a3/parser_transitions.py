...
class PartialParse(object):
    ...
    def parse_step(self, transition):
        ...
        if transition == "S" and len(self.buffer) > 0:
            ...
            raise ValueError("Buffer is empty or Invalid Arch operation is passed in")
...
def minibatch_parse(sentences, model, batch_size):
    ...
    while unfinished_parses:
        ...
        batch_transitions = model.predict(batch_parser)
        for parser, transition in zip(batch_parser, batch_transitions):
